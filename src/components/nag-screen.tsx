...
export function NagScreen({ open, step, onDeclineDonation, onFinalClose, onAccept }: NagScreenProps) {
  ...
  const donationContent = {
    title: "¿Cansado de la publicidad? Apóyanos.",
    ...
    primaryActionText: "Donar y quitar publicidad",
    secondaryActionText: "No, gracias"
  };

  const shareContent = {
    title: "Una alternativa gratis para ganar",
    description: "Entendido. Si no deseas donar, hay otra forma de apoyar y obtener beneficios: regístrate e inicia sesión. Luego, al compartir uno de nuestros pronósticos, obtendrás 24 horas sin publicidad. ¡Es gratis y nos ayudas a crecer!",
